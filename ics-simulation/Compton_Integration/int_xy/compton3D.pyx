...
cdef void fm(double gamma, double aPeak, double omega_omega0_min, double omega_omega0_max, int nout, int ntot, int iTypeEnv, int modType, double theta, double phi, double sign, double sigma_p, double sigma_e_x, double sigma_e_y, str filename):
...
def function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, filename):
    fm(a,b,c,d,e,f,g,h,i,j,k,l,m,n, filename)
    return 1
