# -------------------------------------------------------------------------
# Implementation of algorithms to calculate integration across 3D cross
# sections.
# -------------------------------------------------------------------------
...
# Retrieve the Chirping Prescription given the parameters
...
# Retrieve modulation function from parameters
...
# Implementation of approximate error function (integral of e^-{x^2})
...
# Performs frequency modulation operation within the specified bounds of omega
# (prescribed by omega_omega0_min and omega_omega0_max)
...
# Wrapper function; should be called by external program to calculate cross section. Parameters are
# in the same order as prescribed in fm (written above)
